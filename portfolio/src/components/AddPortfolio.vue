<template>
    <div class="pt-20">
      ...
      <div>
        <input type="text" placeholder="Number" v-model="AddPortfolioData.portfolioNumber" class="white-bg round-corner border-none text-sm w-full h-11 focus:ring-0 mb-4">
  
        <input type="text" placeholder="Category" v-model="AddPortfolioData.portfolioCategory" class="white-bg round-corner border-none text-sm w-full h-11 focus:ring-0 mb-4">
        ...
        <input type="text" placeholder="Status" v-model="AddPortfolioData.portfolioStatus" class="white-bg round-corner border-none text-sm w-full h-11 focus:ring-0 mb-4">
  
        <input type="text" placeholder="Tech" v-model="AddPortfolioData.portfolioTech" class="white-bg round-corner border-none text-sm w-full h-11 focus:ring-0 mb-4">
